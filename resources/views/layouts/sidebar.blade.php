...
<aside id="sidebar"
    ...
    <div class="flex flex-col overflow-y-auto duration-300 ease-linear no-scrollbar">
        ...
        <div x-data x-show="$store.sidebar.isExpanded || $store.sidebar.isHovered || $store.sidebar.isMobileOpen" x-transition class="mt-auto">
            ...
            @auth
                <div class="mx-4 mt-6 border-t border-gray-200 pt-4 dark:border-gray-700">
                    <div class="mb-3">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        ...
                        <button
                            type="submit"
                            class="w-full rounded-lg px-4 py-2 text-left text-sm font-medium text-red-600 hover:bg-red-50 dark:hover:bg-red-900/20"
                        >
                            Logout
                        </button>
                    </form>
